...
- Local dev marketplace must be enabled: `"h-superpowers@h-superpowers-dev": true` in `~/.claude/settings.json`
...
2. Check `~/.claude/settings.json` has `"h-superpowers@h-superpowers-dev": true` in `enabledPlugins`
