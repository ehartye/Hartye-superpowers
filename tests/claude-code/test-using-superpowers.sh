...
run_claude "What is the using-superpowers skill and what does it set up?" 90
show_output
...
run_claude "According to the using-superpowers skill, how should Claude find and use skills from the h-superpowers plugin?" 90
show_output
...
run_claude "According to the using-superpowers skill, when should Claude use skills — only when explicitly asked, or automatically?" 90
show_output
...
run_claude "According to the using-superpowers skill, what skill should be used before starting to build a new feature?" 90
show_output
...
run_claude "Are the workflows in the h-superpowers skills library optional suggestions or mandatory? What does using-superpowers say?" 90
show_output
